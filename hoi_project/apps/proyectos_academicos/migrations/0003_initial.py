...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('proyectos_academicos_proyecto', (
            ...
            ('categorias', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, null=True, to=orm['proyectos_academicos.CategoriasProyecto'])),
        ))
    ...
    models = {
        ...
        'proyectos_academicos.proyecto': {
            ...
            'categorias': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'null': 'True', 'to': "orm['proyectos_academicos.CategoriasProyecto']"}),
