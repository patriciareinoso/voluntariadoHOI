...
from apps.proyectos_academicos.views import write_pdf
from apps.proyectos_academicos.models import (
    Institucion,
    Voluntario,
    Proyecto,
    CategoriasProyecto,
...
#admin.site.register_app_label("proyectos_academicos", _("My awesome web app"))
...
class VoluntarioAdmin(admin.ModelAdmin):
    ...
    def generar_reporte_mes(modeladmin, request, queryset):
        ...
        return render(request, 'admin/institucion_mes.html',
                      {'items': queryset, 'form': form,
                       'title': u'Reporte mensual - Estudiante'})
    ...
    def generar_reporte_ano(modeladmin, request, queryset):
        ...
        return render(request, 'admin/institucion_ano.html',
                      {'items': queryset, 'form': form,
                       'title': u'Reporte anual - Estudiante'})
